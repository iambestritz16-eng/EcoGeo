...
import { Globe, Binary, Droplets, TreePine, Users, Play, Trophy, Zap, Target, Star, Award } from "lucide-react"
      ...
      <header className="border-b border-slate-700 bg-slate-900/90 backdrop-blur-sm sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6">
            ...
            <Link href="/leaderboard" className="text-slate-300 hover:text-emerald-400 font-medium transition-colors">
              Leaderboard
            </Link>
            <Button
              variant="outline"
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
          <Card className="border-slate-700 hover:shadow-xl hover:shadow-emerald-500/10 transition-all bg-slate-800/80 backdrop-blur-sm hover:border-emerald-500/50">
            <CardHeader>
              ...
              <CardTitle className="text-white">Forest Ecosystems</CardTitle>
          ...
          <Link href="/waste" className="block">
            ...
            <CardHeader>
              ...
              <CardDescription className="text-slate-400">
                Dry, Wet and Biodegredable Waste Segregation of Waste
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-3">
